"""
Django settings for Pont_Mbale project.
...
SECRET_KEY = 'django-insecure-8@nngp-iaodcjkc$f%9c#^s&r=o=q7y8zn2bpp7w$2ep767_=3'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Pont_Mbale',  # Replace with your actual database name
        'USER': 'postgres',            # PostgreSQL superuser name
        'PASSWORD': 'postgres',        # PostgreSQL superuser password
